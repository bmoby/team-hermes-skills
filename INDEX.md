...
- `client-idea-analyst-notifications` — Explore notification-based ideas using email, SMS, WhatsApp, Telegram, or similar channels.
- `client-idea-analyst-image-video-ai` — Explore AI image and video content ideas from a validated client profile.
